...
class HenvendelseServiceImpl(private val henvendelsePortType: HenvendelsePortType,
    ...
    override fun hentAlleHenvendelser(fodselsnummer: String?): MutableList<Henvendelse>? {
