                ...
                <article className="send-sporsmal-container send-panel">
                    <form>
                        <div className="sporsmal-header">
                            <img src="/mininnboks/img/melding_graa.svg" alt={Resources.get("meldingikon.alternativ.tekst")}/>
                        ...
                        <div><input type="submit" className="send-link knapp-hoved-stor" role="button" value={Resources.get("send-sporsmal.still-sporsmal.send-inn")} /></div>
                        <div className="avbryt"><Link to="innboks">{Resources.get("send-sporsmal.still-sporsmal.avbryt")}</Link></div>
                    </form>
                </article>
            </div>
        ) : <Snurrepipp />;
