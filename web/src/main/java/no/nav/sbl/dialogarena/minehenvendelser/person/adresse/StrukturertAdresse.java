...
public class StrukturertAdresse extends Adresse implements Copyable<StrukturertAdresse> {
    ...
    public static final Transformer<StrukturertAdresse, String> EIER = new Transformer<StrukturertAdresse, String>() {
        @Override
        public String transform(StrukturertAdresse adresse) {
            return adresse.adresseeier;
        }
    };
