...
final class XMLKontoTransform {
    ...
    static final class TilUtenlandskKonto implements Transformer<XMLBankkontoUtland, UtenlandskKonto> {
        @Override
    ...
    static final class XMLBankkontonummerUtlandToXMLBankkontoUtland implements Transformer<XMLBankkontonummerUtland, no.nav.tjeneste.virksomhet.behandlebrukerprofil.v1.informasjon.XMLBankkontoUtland> {

        @Override
        public no.nav.tjeneste.virksomhet.behandlebrukerprofil.v1.informasjon.XMLBankkontoUtland transform(XMLBankkontonummerUtland kontonummer) {
            return new no.nav.tjeneste.virksomhet.behandlebrukerprofil.v1.informasjon.XMLBankkontoUtland().withBankkontoUtland(kontonummer);
        }
