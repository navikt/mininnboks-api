...
import no.nav.sbl.dialogarena.minehenvendelser.person.common.TekstUtils;
...
import static no.nav.sbl.dialogarena.minehenvendelser.person.GjeldendeAdressetype.FOLKEREGISTRERT;
import static no.nav.sbl.dialogarena.minehenvendelser.person.GjeldendeAdressetype.MIDLERTIDIG_NORGE;
import static no.nav.sbl.dialogarena.minehenvendelser.person.GjeldendeAdressetype.UKJENT;
