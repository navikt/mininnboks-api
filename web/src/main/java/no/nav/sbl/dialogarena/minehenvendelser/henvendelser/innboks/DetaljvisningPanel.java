...
import no.nav.sbl.dialogarena.minehenvendelser.henvendelser.melding.DokumentinnsendingDetaljPanel;
import no.nav.sbl.dialogarena.minehenvendelser.henvendelser.melding.MeldingVM;
import no.nav.sbl.dialogarena.minehenvendelser.henvendelser.melding.MeldingstraadPanel;
...
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.consumer.Meldingstype.DOKUMENTINNSENDING;
