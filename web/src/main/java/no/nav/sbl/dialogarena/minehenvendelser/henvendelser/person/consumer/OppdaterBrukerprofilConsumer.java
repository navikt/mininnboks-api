...
import no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.GjeldendeAdressetype;
import no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.Person;
import no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.ValgtKontotype;
...
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.adresse.StrukturertAdresse.EIER;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.GjeldendeAdresseKodeverk.BOSTEDSADRESSE;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.GjeldendeAdresseKodeverk.MIDLERTIDIG_POSTADRESSE_NORGE;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.GjeldendeAdresseKodeverk.MIDLERTIDIG_POSTADRESSE_UTLAND;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.GjeldendeAdresseKodeverk.POSTADRESSE;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.GjeldendeAdresseKodeverk.UKJENT_ADRESSE;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.transform.Transform.toEpostKommunikasjonskanal;
...
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.transform.Transform.toXMLBankkontoUtland;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.transform.Transform.toXMLBankkontonummerUtland;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.transform.Transform.toXMLElektroniskKommunkasjonskanal;
...
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.transform.Transform.toXMLMidlertidigPostadresseUtland;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.transform.Transform.toXMLMidlertidigPostboksadresse;
