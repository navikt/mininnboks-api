...
import no.nav.sbl.dialogarena.minehenvendelser.person.adresse.Adresse;
import no.nav.sbl.dialogarena.minehenvendelser.person.adresse.AdresseTransform;
import no.nav.sbl.dialogarena.minehenvendelser.person.adresse.StrukturertAdresse;
import no.nav.sbl.dialogarena.minehenvendelser.person.adresse.UstrukturertAdresse;
import no.nav.sbl.dialogarena.minehenvendelser.person.common.UnableToHandleException;
import no.nav.sbl.dialogarena.minehenvendelser.person.konto.UtenlandskKonto;
...
import static no.nav.sbl.dialogarena.minehenvendelser.person.adresse.AdresseTransform.medUtlopsdatoFra;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.GjeldendeAdresseKodeverk.somGjeldendeAdressetype;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.castIfPossibleTo;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.kodeverdi;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.norskKontonummer;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.utenlandskKonto;
