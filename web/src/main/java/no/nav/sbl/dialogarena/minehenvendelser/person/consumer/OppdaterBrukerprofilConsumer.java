...
import no.nav.sbl.dialogarena.minehenvendelser.person.GjeldendeAdressetype;
import no.nav.sbl.dialogarena.minehenvendelser.person.Person;
import no.nav.sbl.dialogarena.minehenvendelser.person.ValgtKontotype;
import no.nav.sbl.dialogarena.minehenvendelser.person.adresse.Adressetype;
import no.nav.sbl.dialogarena.minehenvendelser.person.adresse.StrukturertAdresse;
import no.nav.sbl.dialogarena.minehenvendelser.person.common.UnableToHandleException;
import no.nav.sbl.dialogarena.minehenvendelser.person.telefonnummer.Telefonnummer;
import no.nav.sbl.dialogarena.minehenvendelser.person.telefonnummer.Telefonnummertype;
...
import static no.nav.sbl.dialogarena.minehenvendelser.person.adresse.StrukturertAdresse.EIER;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.GjeldendeAdresseKodeverk.BOSTEDSADRESSE;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.GjeldendeAdresseKodeverk.MIDLERTIDIG_POSTADRESSE_NORGE;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.GjeldendeAdresseKodeverk.MIDLERTIDIG_POSTADRESSE_UTLAND;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.GjeldendeAdresseKodeverk.POSTADRESSE;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.GjeldendeAdresseKodeverk.UKJENT_ADRESSE;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toEpostKommunikasjonskanal;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toXMLBankkontoNorge;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toXMLBankkontoUtland;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toXMLBankkontonummerUtland;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toXMLElektroniskKommunkasjonskanal;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toXMLMatrikkeladresse;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toXMLMidlertidigGateadresse;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toXMLMidlertidigPostadresseUtland;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toXMLMidlertidigPostboksadresse;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toXMLStedsadresseNorge;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.toXMLTelefontype;
