...
import no.nav.sbl.dialogarena.minehenvendelser.person.transform.XMLBankkontoNorgeInToXMLBankkontoNorgeOut;
import no.nav.sbl.dialogarena.minehenvendelser.person.transform.XMLBankkontoUtlandInToXMLBankkontoUtlandOut;
import no.nav.sbl.dialogarena.minehenvendelser.person.transform.XMLPersonidenterInToXMLPersonidenterOut;
import no.nav.sbl.dialogarena.minehenvendelser.person.transform.XMLPostadresseTyperInToXMLPostadresseTyperOut;
