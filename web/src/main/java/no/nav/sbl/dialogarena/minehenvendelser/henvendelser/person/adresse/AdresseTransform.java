...
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.adresse.Adressekodeverk.*;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.adresse.Adressetype.*;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.transform.Transform.kodeverdi;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.consumer.transform.Transform.sluttdato;
