...
import static no.nav.sbl.dialogarena.minehenvendelser.person.adresse.Adressekodeverk.*;
import static no.nav.sbl.dialogarena.minehenvendelser.person.adresse.Adressetype.*;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.kodeverdi;
import static no.nav.sbl.dialogarena.minehenvendelser.person.consumer.transform.Transform.sluttdato;
