...
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.adresse.GyldigPostnummer.finnesI;
...
public class GyldigPostnummerTest implements Adressekodeverk, Serializable {
    ...
    private Predicate<String> gyldigPostnummer = both(GyldigPostnummer.FIRE_TEGN).and(GyldigPostnummer.NUMERISK).and(finnesI(this));
