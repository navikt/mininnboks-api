...
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.adresse.Adresse.toAdresselinjer;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.adresse.Adressetype.BOSTEDSADRESSE;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.adresse.Adressetype.GATEADRESSE;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.adresse.Adressetype.OMRAADEADRESSE;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.adresse.Adressetype.POSTBOKSADRESSE;
import static no.nav.sbl.dialogarena.minehenvendelser.henvendelser.person.adresse.Adressetype.UTENLANDSK_ADRESSE;
